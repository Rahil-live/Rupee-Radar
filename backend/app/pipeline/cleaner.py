...
def clean_description(raw: str, merchants: dict[str, dict] | None = None) -> tuple[str, str | None]:
    ...
    # Don't collapse description_clean to just the merchant name — keep the full
    # cleaned text so that labels like "HOME LOAN EMI HDFC" are preserved.
    # The merchant field is used separately for grouping/display.
